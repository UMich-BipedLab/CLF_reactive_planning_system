#include "info_to_robot_t.h"
#include <stddef.h>
#include <string.h>
#include <stdio.h>

void pack_info_to_robot_t(const info_to_robot_t *bus, unsigned char bytes[188])
{
    int i0;
    unsigned char y[28];
    float x[7];
...
void unpack_info_to_robot_t(const unsigned char bytes[188], info_to_robot_t *bus)
{
    int i;
    float y[7];
    unsigned char x[28];
